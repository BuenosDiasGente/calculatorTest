package pro.sky.java.cours2.calculatortest.controller;

import org.springframework.web.bind.annotation.GetMapping;
import org.springframework.web.bind.annotation.RequestMapping;
import org.springframework.web.bind.annotation.RequestParam;
import org.springframework.web.bind.annotation.RestController;
import pro.sky.java.cours2.calculatortest.service.CalculatorService;
...
public class CalculatorController {
    ...
    public String plus(@RequestParam ("num1") Integer num1,
        ...
        if(num1==null||num2==null){
            throw new RuntimeException("Подайте параметры!");
        }
